package pe.edu.cibertec.EF_Obispo_Ricardo_DAW1.api;
...
import pe.edu.cibertec.EF_Obispo_Ricardo_DAW1.response.*;
    ...
    public DeleteCarResponseById deleteCarByID(@RequestParam(value = "id", defaultValue = "0") String id) {
        try {
            ...
            if (carId > 0) {
                ...
                if (deleted) {
                    return new DeleteCarResponseById("01", "Carro eliminado");
                } else {
